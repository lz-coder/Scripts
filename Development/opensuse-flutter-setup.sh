...
sudo zypper install -y clang cmake git-core gh gtk3-devel ninja pkgconf-pkg-config xz-devel libstdc++-devel pinentry-gnome3 libsecret chromium gnome-themes-extras google-droid-fonts
